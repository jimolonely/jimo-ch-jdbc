...
public class ClickHousePreparedStatementImpl implements ClickHousePreparedStatement {
    ...
    @Override
    public ResultSet executeQuery(Map<ClickHouseQueryParam, String> additionParams) throws SQLException {
        return null;
    }

    @Override
    public int[] executeBatch(Map<ClickHouseQueryParam, String> additionalParams) throws SQLException {
        return new int[0];
    }
